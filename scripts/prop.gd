...
func _on_enter_area_center_sensor(area: Area2D):
	center_lit = true;
	update_light_ratio();

func _on_enter_area_top_sensor(area: Area2D):
	top_lit = true;
	update_light_ratio();

func _on_enter_area_bottom_sensor(area: Area2D):
	bottom_lit = true;
	update_light_ratio();

func _on_enter_area_left_sensor(area: Area2D):
	left_lit = true;
	update_light_ratio();

func _on_enter_area_right_sensor(area: Area2D):
	right_lit = true;
	update_light_ratio();



func _on_exit_area_center_sensor(area: Area2D):
	center_lit = false;
	update_light_ratio();

func _on_exit_area_top_sensor(area: Area2D):
	top_lit = false;
	update_light_ratio();

func _on_exit_area_bottom_sensor(area: Area2D):
	bottom_lit = false;
	update_light_ratio();

func _on_exit_area_left_sensor(area: Area2D):
	left_lit = false;
	update_light_ratio();

func _on_exit_area_right_sensor(area: Area2D):
	right_lit = false;
	update_light_ratio();
